...
public class ConsultaAutomovil extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CONSULTA DE AUTOMÓVIL");
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        // Control de que la tabla no este vacia
        //aca estan los controles con los if
        if(tablaAutos.getRowCount()>0){
            //valido que se haya seleccionado un registro
            if(tablaAutos.getSelectedRow()!=-1){
                ...
                //para que luego se apretar btnModificar se cierre esa ventana y deje solo la que se abre debemos hacer esto:
                this.dispose();
            }
             else{
